...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -8.669".mt_rand(100,999).",115.21".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -7.000".mt_rand(100,999).",110.43".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: 3.5778".mt_rand(100,999).",98.685".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
