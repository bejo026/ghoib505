...
echo "\n";
echo "\e[96mبسم الله الرحمن الرحيم   \n";
echo "\e[96mOPERATOR SIAP MELAYANI ANDA \n";
// function change(){
        $nama = nama();
        $email = str_replace(" ", "", $nama) . mt_rand(100, 999);
        echo color("purple","馃摬鈻讹笍 Nomor : ");
        // $no = trim(fgets(STDIN));
        ...
        echo color("green","鉁旓笍鈻讹笍 Berhasil mendaftar\n");
        ...
        echo "\n".color("nevy","馃敀鈻讹笍 Claim Voucher 2: ");
        //echo "\n".color("yellow","鈴斥柖锔� Please wait");
        for($a=0;$a<=5;$a++){
          echo color("yellow",$a);
          sleep(1);}
        ...
        echo "\n".color("nevy","馃敀鈻讹笍 Claim Voucher 3: ");
        //echo "\n".color("yellow","鈴斥柖锔� Please wait");
        for($a=0;$a<=5;$a++){
          echo color("yellow",$a);
          sleep(1);}
